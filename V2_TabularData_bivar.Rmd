...
<span style="color:red"> Exercise:<br> Turn the bars into lollipop with the right components.
</span>
...
<span style="color:red"> Exercise:<br> Change the heatplot to ascending order, where intensity goes from yellow to purple.
</span>
_____
...
<span style="color:red"> Exercise:<br> Complete the information needed in the previous plots.
</span>
...
<span style="color:red"> Exercise:<br> Complete the elements missing in the previous plots.
</span>
